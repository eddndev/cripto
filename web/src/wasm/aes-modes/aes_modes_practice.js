/* @ts-self-types="./aes_modes_practice.d.ts" */
 ...
 * @returns {string}
 */
export function derive_key(passphrase, salt, iters, out_len) {
    let deferred3_0;
    let deferred3_1;
    try {
        ...
        const ret = wasm.derive_key(ptr0, len0, ptr1, len1, iters, out_len);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 * @returns {any}
 */
export function process(direction, mode, key, iv, data) {
    ...
    const ret = wasm.process(ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3, ptr4, len4);
    if (ret[2]) {
 ...
 * @returns {string}
 */
export function random_hex(n) {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.random_hex(n);
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
        return getStringFromWasm0(ret[0], ret[1]);
    } finally {
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./aes_modes_practice_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('aes_modes_practice_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
