...
Encrypt a flat bitmap with **ECB** and the original silhouette leaks straight through the
ciphertext — the classic *Tux* / *ECB penguin* image. Switch to **CBC**, **CFB**, **OFB**
or **CTR** with a fresh IV and the same file turns into uniform noise. That visual
contrast *is* the demo: ECB preserves structure, the other four hide it.
