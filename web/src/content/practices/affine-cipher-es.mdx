...
El cifrado afín encripta aplicando una función lineal sobre aritmética modular. Dados las claves **α** (multiplicativa) y **β** (aditiva) sobre un alfabeto de tamaño **n**:
